package server
import("encoding/json";"net/http";"github.com/stockyard-dev/stockyard-dossier/internal/store")
...
func(s *Server)routes(){
    ...
    s.mux.HandleFunc("PATCH /api/contacts/{id}",s.handleUpdateContact)
...
func(s *Server)handleHealth(w http.ResponseWriter,r *http.Request){writeJSON(w,200,map[string]string{"status":"ok","service":"stockyard-dossier"})}
