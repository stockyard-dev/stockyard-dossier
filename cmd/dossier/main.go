...
import (
	...
	"github.com/stockyard-dev/stockyard-dossier/internal/license"
...
func main() {
	...
	licenseKey := os.Getenv("DOSSIER_LICENSE_KEY")
	...
	log.Printf("Stockyard Dossier listening on :%s (tier: %s)", port, tier)
